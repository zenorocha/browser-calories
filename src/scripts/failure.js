    ...
    return (
      <div class="status">
        ...
        <div class="status-msg">
          <p>{title}</p>
          <p>Try again on another tab or fill an <a href={"https://github.com/zenorocha/browser-calories/issues/new?title=Error+" + this.config.error.code + "+for+" + this.config.url + "&body=%3E+" + this.config.error.message} target="_blank">issue on GitHub</a></p>
        </div>
      </div>
    )
  }
